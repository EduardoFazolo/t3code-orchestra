                        ...
                        <Collapsible className="group/collapsible" open={project.expanded}>
                          ...
                          >
                            <SidebarMenuButton
                              size="sm"
                              className={cn(
                                "gap-2 px-2 py-1.5 text-left cursor-grab active:cursor-grabbing hover:bg-accent group-hover/project-header:bg-accent group-hover/project-header:text-sidebar-accent-foreground transition-all duration-150",
                                ...
                                return (
                                  ...
                                  >
                                    <SidebarMenuSubButton
                                      ...
                                      isActive={isActive}
                                      className={cn(
                                        "h-7 w-full translate-x-0 cursor-default justify-start px-2 text-left select-none hover:bg-accent hover:text-foreground focus-visible:ring-0 transition-all duration-150",
                                        isSelected
